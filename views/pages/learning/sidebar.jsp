	...
	<div class="sidebar sidebar-light sidebar-fixed" id="sidebar">
		...
		<ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
			...
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath}/learning/home"> <svg
						class="nav-icon">
            <use
							xlink:href="${pageContext.request.contextPath}/admin/vendors/@coreui/icons/svg/free.svg#cil-"></use>							
          </svg>Báo cáo thống kê
			</a><a class="nav-link"
				href="${pageContext.request.contextPath}/learning/vocabulary"> <svg
						class="nav-icon">
            <use
							xlink:href="${pageContext.request.contextPath}/admin/vendors/@coreui/icons/svg/free.svg#cil-"></use>							
          </svg>Từ vựng
			</a><a class="nav-link"
				href="${pageContext.request.contextPath}/learning/grammar"> <svg
						class="nav-icon">
            <use
							xlink:href="${pageContext.request.contextPath}/admin/vendors/@coreui/icons/svg/free.svg#cil-"></use>							
          </svg>Ngữ pháp
